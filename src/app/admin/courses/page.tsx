...
const Page = () => {
    ...
    return (
    <section  className={`${toggle ? 'col-span-9' : 'col-span-8'} bg-white rounded-[20px] p-6 mt-5 overflow-y-scroll no-scrollbar space-y-6 shadow-sm`}>
        <div className='flex justify-between items-center'>
            <h1 className='text-lg font-normal text-black'>Course Management</h1>

            <Button asChild className='flex items-center gap-2 text-white font-normal transition-colors'>
        ...
        <div className='flex justify-between items-center gap-4'>
            ...
            <div className='flex items-center gap-2 flex-1 max-w-2xl'>
                <div className='border border-neutral-400 flex items-center gap-3 rounded-full py-2.5 px-4 h-11 flex-1'>
                ...
                <button className='flex items-center gap-1 border border-neutral-400 rounded-full py-2.5 px-4 h-11 text-sm whitespace-nowrap hover:bg-neutral-50 transition-colors'>
                        ...
                        <tr key={`course-${index}`} className="border-b border-neutral-50">
                            ...
                            <td className="py-4 px-2">
                                <div className="flex items-center gap-5">
                                    <button className="text-neutral-800 hover:text-neutral-900 transition-colors" onClick={()=>setIsSuspendModalOpen(true)}>
                                    ...
                                    <button className="text-neutral-800 hover:text-neutral-900 transition-colors" onClick={()=>setIsDeleteModalOpen(true)}>
