import { AchievementBadgeCardProps, CertificateCardProps, PersonalInfoProps } from "@/features/profile/types";
  ...
  export const personalInfo: PersonalInfoProps = {
   ...
   export const allAchievedBadges: AchievementBadgeCardProps[] = [
      {
   ...
   export const allAchievedCertificates: CertificateCardProps[] = [
         {
