      ...
      <aside className="col-span-2 hidden md:block border-r-2 border-neutral-100 h-screen px-5 text-neutral-700  min-w-[200px] max-w-[291px] grow">
         ...
         <nav className="grid gap-8 mt-5">
            <div className="flex justify-between">
               <Link
                  href="/home"
                  className={`flex gap-5 hover:cursor-pointer ${home ? activeLink : ''}`}
               >
                  <ReactSVG
                     src={`/icons/home${home ? '' : '-outline'}.svg`}
                     width={25}
                     height={25}
                  />
                  <span>Home</span>
            ...
            <Link
               href="/home/explore"
               className={`flex gap-5 hover:cursor-pointer ${explore ? activeLink : ''}`}
            >
               <ReactSVG
                  src={`/icons/search${explore ? '' : '-outline'}.svg`}
                  width={25}
                  height={25}
               />
               <span>Explore</span>
            ...
            <Link
               ...
               className={`flex gap-5 hover:cursor-pointer ${myCourses ? activeLink : ''}`}
            >
               <ReactSVG
                  src={`/icons/book${myCourses ? '' : '-outline'}.svg`}
                  width={25}
                  height={25}
               />
            ...
            <Link
               href="/home/community"
               className={`flex gap-5 hover:cursor-pointer ${community ? activeLink : ''}`}
            >
               <ReactSVG
                  src={`/icons/people${community ? '' : '-outline'}.svg`}
                  width={25}
                  height={25}
               />
               <span>Community</span>
            ...
            <Link
               ...
               className={`flex gap-5 hover:cursor-pointer ${myProfile ? activeLink : ''}`}
            >
               <ReactSVG
                  src={`/icons/user${myProfile ? '' : '-outline'}.svg`}
                  width={25}
                  height={25}
               />
            ...
            <Link
               href="/home/settings"
               className={`flex gap-5 hover:cursor-pointer ${settings ? activeLink : ''}`}
            >
               <ReactSVG
                  src={`/icons/setting${settings ? '' : '-outline'}.svg`}
                  width={25}
                  height={25}
               />
               <span>Settings</span>
...
export const Tabs: React.FC = () => {
   ...
   return (
      <footer className={` ${isCourseOverviewPage && "hidden"} grid md:hidden grid-cols-5 h-20 items-center justify-center *:flex *:flex-col *:justify-center *:items-center *:text-tab border-t border-neutral-100 `}>
         ...
         <Link
            href="/home/explore"
            className={`flex gap-1 hover:cursor-pointer ${explore ? activeLink : '*:text-neutral-700'}`}
         >
            <ReactSVG
               src={`/icons/search${explore ? '' : '-outline'}.svg`}
               width={25}
         ...
         <Link
            href="/home/my-courses"
            className={`flex gap-1 hover:cursor-pointer ${myCourses ? activeLink : '*:text-neutral-700'}`}
         >
            <ReactSVG
               src={`/icons/book${myCourses ? '' : '-outline'}.svg`}
               width={25}
         ...
         <Link
            href="/home/community"
            className={`flex gap-1 hover:cursor-pointer ${community ? activeLink : '*:text-neutral-700'}`}
         >
            <ReactSVG
               src={`/icons/people${community ? '' : '-outline'}.svg`}
               width={25}
         ...
         <Link
            href="/home/my-profile"
            className={`flex gap-1 hover:cursor-pointer ${myProfile ? activeLink : '*:text-neutral-700'}`}
         >
            <ReactSVG
               src={`/icons/user${myProfile ? '' : '-outline'}.svg`}
               width={25}
