...
const Page: React.FC = () => {
   ...
   return (
         ...
         <section className="  max-sm:py-0 md:w-auto  flex justify-center items-center min-h-screen lg:py-16.25 ">
            <div className=" basis-full  md:rounded-[20px] px-5 max-sm:px-4 pt-6 md:max-w-117  md:h-fit py-7.5 w-screen md:w-auto sm:border border-neutral-400 rounded-[20px] bg-surface">
