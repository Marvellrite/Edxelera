...
const Header = () => {
  return (
    <header className='admin-topbar h-24 w-full col-span-1 md:col-span-12 rounded-2xl py-2 px-3 md:px-4 flex justify-between items-center gap-3'>
        ...
        <section className='flex items-center gap-2 md:gap-5'>
            ...
            <div className='flex gap-2 md:gap-3 items-center'>
                ...
                <div className='flex items-center gap-3'>
                    <Image src="https://res.cloudinary.com/dx5iohojj/image/upload/v1773340674/repo-images/public/photo.png" alt='logo' height={100} width={100} className='h-10 w-10 object-contain' />
                    {/* <ReactSVG src='https://res.cloudinary.com/dx5iohojj/image/upload/v1773340473/repo-images/public/icons/dropdown.svg' /> */}
                </div>

                <div className='hidden sm:block'>
                    <p className='admin-muted text-[14px] font-normal'>Good morning</p>
                    <p className='admin-title text-[15px] font-medium'>David David</p>
                </div>
